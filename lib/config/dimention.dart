...
double textSizeSmallest = 0.024;
double textSizeSmaller = 0.025;
double textSizeSmall = 0.026;
double textSizeRegular = 0.027;
double textSizeMediumBig = 0.028;
double textSizeBig = 0.030;
double textSizeLarge = 0.032;
double textSizeLargest = 0.036;
...
double commonBtnWidthSmaller = 0.3;
double commonBtnWidthSmallest = 0.2;
